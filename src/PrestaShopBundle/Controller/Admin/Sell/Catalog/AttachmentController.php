 ...
 */
class AttachmentController extends PrestaShopAdminController
{
    ...
    {
        $attachmentInfo = $this->dispatchQuery(new GetAttachmentInformation($attachmentId));
    ...
    private function presentAttachmentInfo(AttachmentInformation $productAttachmentInfo): array
    {
        ...
        return [
            ...
            'name' => $localizedNames[$this->getLanguageContext()->getId()] ?? reset($localizedNames),
